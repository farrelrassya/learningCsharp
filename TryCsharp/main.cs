...
namespace BootCamp.Chapter1
{
    ...
    class Program
    {
        ...
        /*
         This is a multiline comment. It starts with 
         "/*" and ends with "* /" (no space) 
        */
        // Comments are just text which will be taken as an instruction, thus will be skipped.
        // Running with VS menu will put the application in debug mode.
        ...
        {
            // PascalCase (first letter is capital and all other words start with a capital letter)
            // camelCase (first letter is non-capital and all other words start with a capital letter)
            ...
            // you can only multiply and divide numbers
